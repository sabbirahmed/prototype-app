                  ...
                  Material(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            "In nulla consequat et reprehenderit ut occaecat velit laboris Lorem do.",
                          ),
                          const SizedBox(
                            height: 8,
                          ),
                          Row(
                            ...
                            children: [
                              Text(
                                timeago.format(isCurrentUser ? DateTime.now().subtract(const Duration(minutes: 15)) : DateTime.now()),
                              )
                            ],
                          )
                        ],
